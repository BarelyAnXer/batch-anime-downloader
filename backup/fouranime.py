...
browser = webdriver.Chrome(r"C:\Users\63966\Desktop\chrome driver\chromedriver.exe")#,options=options)
...
def main():
    a = FourAnimeScraper("https://4anime.to/anime/dungeon-ni-deai-wo-motomeru-no-wa-machigatteiru-darou-ka")
    a.downloadVideo()
